  ...
  <transition name="open" mode="out-in">
    <section class="hero" v-if="project && id !== 0" :key="id">
      ...
      <div class="hero__info" v-if="project">
        ...
        <div class="hero__buttons" v-if="project.links">
          <a :href="item.link" target="_blank" v-for="item of project.links">{{
            item.name
          }}</a>
        </div>
      </div>
    ...
    <section class="hero" v-else :key="0">
      <div>
        ...
        >
          <path
            :id="isAnimationPlayed ? '' : 'welcome_path'"
            @animationend="playAnimation()"
            style="stroke: rgb(204, 204, 204); fill: rgb(204, 204, 204)"
            stroke="none"
