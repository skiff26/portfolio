...
const id = computed<number>(() => projectStore.projectId)
const project = computed(() => projectStore.getCurrentProject())

const isAnimationPlayed = ref<boolean>(false)
const playAnimation = () => isAnimationPlayed.value = true
</script>