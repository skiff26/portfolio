export default {
	...
	otherPosts: [
		...
		},
		{
			...
			info: 'Проект находится в разработке. На данный не момент реализован функционал рокировки, матов и бития фигур корлем, которые находятся под защитой.',
		},
		{
			id: 7,
			photos: ['00','01','02','03'],
		...
		},
		{
			...
			fullText: 'Input для ввода IP, с проверкой на правильность ввода, и кнопка получение информации, которая автоматически меняет свой текст от ситуации. Есть красивый loader.',
		},
		{
			id: 9,
			photos: ['00','01','02','03'],
