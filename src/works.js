export default {
	...
	otherPosts: [
		...
		},
		{
			...
			title: 'Tic-Tac-Toe - Крестики нолики',
			theme: 'Web programming',
			year: '2023',
			path: "tictactoe",
			alt: 'Tictactoe',
			text: 'WEB игра крестики нолики. Стили написаны по методологии БЭМ с использованием SCSS. Логика игры написана на Vue 3, есть vue.js анимации. Дизайн максимально простой, чтобы было удобно играть. ',
		},
		{
			id: 10,
			photos: ['00','01','02','03'],
