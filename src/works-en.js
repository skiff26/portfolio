export default {
	...
	otherPosts: [
		...
		},
		{
			...
			title: 'Timefrom - Calculate time elapsed',
			theme: 'Web programming',
			year: '2023',
			path: "timefrom",
			alt: 'Timefrom',
			text: 'This is a web application developed for the administration of Radmir RP. It is designed for convenient and quick determination of the time that has passed since the moment a fraps was taken during complaint review.',
		...
		},
		{
			...
			path: "tictactoe",
			alt: 'Tictactoe',
			text: 'This is a web game called "Tic-Tac-Toe" created using the BEM methodology and written in Vue 3. The game utilizes animations from vue.js. The game design is kept minimalistic for the convenience of players.',
		...
		},
		{
			...
			title: 'Lacator - IP information lookup',
			theme: 'Web programming',
			year: '2023',
			path: "locator",
			alt: 'Locator',
			text: 'WEB application for obtaining information about an IP address. The interface is simple and intuitive. There are 3 buttons at the top: 1 - clear the information, 2 - open the IP on Google Maps, 3 - cancel the action of the 1st button. ',
